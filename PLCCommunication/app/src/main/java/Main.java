...
//            try
//            {
//                System.out.println("连接到主机：" + "192.168.56.1" + " ，端口号：" + 61000);
//                Socket client = new Socket("192.168.56.1", 61000);
...
//            }
    ...
    private static void SiemesTest(){
        SiemensS7Net siemens_net = new SiemensS7Net(SiemensPLCS.S1200,"192.168.0.1",102);
